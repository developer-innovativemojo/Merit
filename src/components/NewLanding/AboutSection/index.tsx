...
const AboutSection = () => {
  return (
    <div className="min-h-[493px] flex items-center justify-center relative mt-[193px]">
      <Image className="absolute z-[0] object-cover w-full" src={bg} alt="" />
      <Image
        className="absolute z-[0] object-cover bottom-[-100px] w-[992px]"
        src={greenbg}
        alt=""
      />
      <div className="w-full max-w-[1200px]">
        <div className="max-w-[990px] w-full mx-auto flex flex-wrap justify-between gap-8 items-center mob:px-5  ">
          <Text as="h1" className="text-accentGreen text-[50px] font-inter">
            About
          </Text>

          <Text className="max-w-[683px] w-full font-inter text-[#30434D] text-[18px] leading-[26px]">
        ...
        <Text className="font-inter text-[24px] mt-[82px] text-center mx-auto">
