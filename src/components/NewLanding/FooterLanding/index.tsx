    ...
    return (
        <div className=" bg-white  pt-16 pb-6 px-5 mob:pb-16 mob:pt-0 relative">
            <div className="flex justify-start items-center overflow-hidden min-h-[450px] mob:min-h-[100%] max-w-[1200px] mx-auto">
                <div className="max-w-[964.82px] w-full flex flex-wrap gap-[55px] relative z-20 ">
                    ...
                    <div className=" w-full max-w-[149px] mob:mt-5 ">
                        <Text className="text-[#30434D] text-[24px] font-bold font-inter mob:text-[22px] mb-[28px] mob:mb-2">
                            Company
                        </Text>
                        ...
                        <div className="flex flex-wrap gap-[25px]">
                            ...
                            <Link
                                href="#"
                                className={`text-[#30434D]  leading-[25.89px] text-[18px] uppercase font-inter    font-normal  mob:text-[15px]  ${currentPath === "#"
                    ...
                    <div className=" w-full max-w-[149px] mob:mt-5 ">
                        ...
                        <div className="flex flex-wrap gap-[25px]">
                            <Link
                                href="#"
                                className={`text-[#30434D] w-full  leading-[25.89px] text-[18px] uppercase font-inter   font-normal  mob:text-[15px]  ${currentPath === "#"
                                    ? "text-accentGreen font-semibold"
                                    : "text-[#30434D]"
                                    }`}
                            >
            ...
            <Image className="absolute right-0 bottom-0 h-full w-auto z-0 mob:max-w-[35%] mob:h-auto" src={decoration} alt="" width={415.99} height={524.9} />
